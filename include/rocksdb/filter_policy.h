...
extern const FilterPolicy* NewOasisFilterPolicy(double bpk, size_t block_sz);
extern const FilterPolicy* NewOasisPlusFilterPolicy(double bpk, size_t block_sz,
                                                    size_t max_qlen);
